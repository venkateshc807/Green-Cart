...
const MainBanner = () => {
  return (
    ...
    justify-end md:justify-center pb-24 md:pb-0 px-4 md:pl-18 lg:pl-24'>
        ...
        max-w-72 md:max-w-105 leading-tight lg:leading-15'>
        Freshness You Can Trust, Savings You Will Love!</h1>


    <div className='flex items-center mt-6 font-medium'>
        <Link to={"/products"} className='group flex items-center gap-2 px-7 md:px-9 cursor-pointer
        py-3 bg-primary hover:bg-primary-dull transition rounded text-white '>
        Shop Now
        <img 
