...
const Cart = () => {
    ...
    const getUserAddress = async () => {
        try {
            ...
            const errMsg = error?.response?.data?.message || error?.message || "Error fetching address"
            toast.error(errMsg)
        }
    }
    ...
    const placeOrder = async () => {
        try {
            ...
            const errMsg = error?.response?.data?.message || error?.message || "Order placement failed"
            toast.error(errMsg)
        }
    }
    ...
    if (!products.length || !cartItems) {
        return <div className="mt-20 text-center">Loading your cart...</div>
    }
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="mb-6">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        ...
                        <button onClick={() => setShowAddress(!showAddress)} className="text-primary hover:underline cursor-pointer ml-2">
                            Change
                        </button>
                        {showAddress && (
                            <div className="absolute top-12 left-0 right-0 py-1 bg-white border border-gray-300 text-sm z-10">
